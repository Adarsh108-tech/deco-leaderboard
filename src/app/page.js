...
const LeaderBoard = () => {
  ...
  return (
    <main className="relative w-full min-h-screen bg-transparent">
      {/* Background Image */}
      <img
        className="fixed top-0 left-0 w-full h-full object-cover blur-[3.5px] -z-10"
        alt="Background"
        src="https://c.animaapp.com/macop9gcz0nwau/img/5a177b84-e98e-4e98-998d-59980388ca23.png"
      />
      {/* Overlay */}
      <div className="fixed top-0 left-0 w-full h-full bg-[#00000073] backdrop-blur-[2.25px] -z-10" />

      {/* Content */}
      <div className="relative w-full flex flex-col items-center justify-start px-4 py-8 z-[1]">
        <h1 className="mt-4 mb-6 text-white font-extrabold text-[28px] sm:text-[36px] md:text-[48px] text-center tracking-[2px] leading-tight">
          LEADERBOARD
        </h1>
        ...
        {/* Top 3: Desktop */}
        <div className="hidden sm:flex flex-row justify-center gap-4 mt-8 w-full items-center">
          {[1, 0, 2].map((i) => {
        ...
        {/* Remaining Entries */}
        <div className="w-[98vw] max-w-2xl sm:w-[900px] mt-6 pb-16">
      ...
      {/* Decorations */}
      <img
        className="hidden sm:block fixed left-0 bottom-0 h-full max-h-[110vh] w-auto object-contain pointer-events-none"
        src="https://c.animaapp.com/macop9gcz0nwau/img/picsart-25-04-23-00-35-47-789.png"
        alt="Decorative left"
      />
      <img
        className="hidden sm:block fixed right-0 bottom-0 h-full max-h-[110vh] w-auto object-contain pointer-events-none"
